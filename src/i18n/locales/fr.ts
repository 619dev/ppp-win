export const fr: Record<string, string> = {
  ...
  'chat.group_unencrypted_warning': 'Le chat de groupe n\'est pas chiffré. Des bots peuvent être ajoutés. Ne partagez pas d\'informations personnelles privées.',
  ...
  'group.encryption_switch_confirm': 'Changer le mode de chiffrement supprimera tout l\'historique de chat. Continuer ?',
  ...
  'group.encryption_changed': 'Le mode de chiffrement a été modifié. L\'historique de chat a été supprimé.',
  ...
  'group.owner_only_encryption': 'Seul le propriétaire du groupe peut basculer le chiffrement',
